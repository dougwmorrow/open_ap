...
def extract_windowed(
    ...
    if configuration.OVERLAP_MINUTES > 0:
        if configuration.OVERLAP_MINUTES >= 1440:
            overlap_days = configuration.OVERLAP_MINUTES // 1440
            ...
            logger.info(
                ...
                configuration.OVERLAP_MINUTES, overlap_days, target_date, table_config.source_object_name,
            )
        else:
            logger.info(
                ...
                configuration.OVERLAP_MINUTES, table_config.source_object_name,
            )
