...
- [04_EDGE_CASES.md](04_EDGE_CASES.md) — **"Does this design address edge case <X> in series M/S/I/N/P/G/D/F/V/T/DP/SI/SE/PL?"** Read when: signing off a round, reviewing pipeline code, or invoking `udm-edge-case-validator`. **14 canonical series total** (Math / SCD2 / Idempotency / Network-Parquet / PII / Gap-detection / 2x-day / Failover / Vault / Testing / Deployment-pipeline / Self-improvement / Source-exactness — Phase A / **udm-progress-logger discipline**). Status: ✅ Mitigated / 🟡 Planned / 🔴 Open.
